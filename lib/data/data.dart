...
final List<Question> questions = [
  ...
  Question(
    ...
    options: [
      Option(id: 1, text: "Preventivas, restrictivas, informativas"),
  ...
  Question(
    ...
    category: QuestionCategory.senales,
    explanation:
        'La luz roja obliga a detenerse completamente antes de la línea de alto, respetando el área de cruce peatonal para garantizar la seguridad de quienes cruzan.',
  ),
  Question(
    id: 37,
    text:
    ...
    category: QuestionCategory.senales,
    explanation:
        'La única excepción para cruzar un semáforo en rojo es cuando un oficial de tránsito lo indica. Las señales del oficial prevalecen sobre las señales luminosas.',
  ),
  Question(
    id: 38,
    ...
    category: QuestionCategory.senales,
    explanation:
        'Las rayas longitudinales (paralelas al sentido de circulación) separan los carriles y orientan a los conductores para mantenerse dentro de su carril.',
  ),
  Question(
    id: 39,
    ...
    category: QuestionCategory.senales,
    explanation:
        'Las rayas transversales (perpendiculares al sentido de circulación) marcan dónde deben detenerse los vehículos y delimitan las zonas seguras para el cruce de peatones.',
  ),
  Question(
    id: 42,
    ...
    category: QuestionCategory.senales,
    explanation:
        'Los fantasmas o indicadores de alumbrado son dispositivos reflectantes que delimitan los bordes de los acotamientos, ayudando a los conductores a ver los límites de la carretera, especialmente de noche.',
  ),
  Question(
    id: 43,
    ...
    category: QuestionCategory.senales,
    explanation:
        'Las señales restrictivas imponen limitaciones o prohibiciones. Se reconocen por su forma circular con borde rojo. Ejemplo: "Alto", "Velocidad máxima", "No estacionarse".',
  ),
  Question(
    id: 51,
    ...
    category: QuestionCategory.senales,
    explanation:
        'Las señales preventivas alertan sobre peligros o cambios en la vía. Tienen forma de rombo con fondo amarillo. Ejemplo: "Curva peligrosa", "Cruce de peatones".',
  ),
  Question(
    id: 54,
    ...
    category: QuestionCategory.senales,
    explanation:
        'Las señales informativas orientan y guían al conductor. Son rectangulares con fondo verde o azul. Incluyen nombres de calles, destinos, distancias y servicios cercanos.',
  ),
  ...
  Question(
    ...
    explanation:
        'En zonas con alta concentración de personas (escuelas, hospitales, oficinas públicas), el límite se reduce a 20 km/h para proteger la vida de peatones.',
  ),
  Question(
    id: 6,
    ...
    category: QuestionCategory.circulacion,
    explanation:
        'En el Estado de México, la vuelta a la derecha con semáforo en rojo NO está permitida bajo ninguna circunstancia, a diferencia de otras entidades.',
  ),
  Question(
    id: 9,
    text:
    ...
    category: QuestionCategory.circulacion,
    explanation:
        'Los vehículos de servicio público deben circular exclusivamente por los carriles laterales. Los carriles centrales están reservados para vehículos particulares.',
  ),
  Question(
    id: 14,
    ...
    category: QuestionCategory.circulacion,
    explanation:
        'Las carreras callejeras ("arrancones") y obstruir la vialidad con objetos están estrictamente prohibidos por poner en riesgo la seguridad de todos los usuarios de la vía.',
  ),
  Question(
    id: 21,
    text:
    ...
    category: QuestionCategory.circulacion,
    explanation:
        'Las banquetas y áreas peatonales son de uso exclusivo para peatones. Ningún vehículo motorizado, incluidas las motocicletas, puede circular por ellas.',
  ),
  Question(
    id: 40,
    text:
    ...
    category: QuestionCategory.circulacion,
    explanation:
        'Las señales manuales son: brazo izquierdo extendido hacia arriba = vuelta a la derecha; brazo extendido hacia abajo = vuelta a la izquierda. Son obligatorias si las direccionales no funcionan.',
  ),
  Question(
    id: 41,
    text:
    ...
    category: QuestionCategory.circulacion,
    explanation:
        'La distancia mínima de 5 metros permite al conductor tener visibilidad suficiente y espacio de reacción ante la aproximación de un tren.',
  ),
  Question(
    id: 44,
    text:
    ...
    category: QuestionCategory.circulacion,
    explanation:
        'Las carreras o "arrancones" están totalmente prohibidos en la vía pública. Son una infracción grave que pone en peligro la vida de todos los usuarios.',
  ),
  Question(
    id: 49,
    ...
    category: QuestionCategory.circulacion,
    explanation:
        'El acotamiento es un área de emergencia, no un carril de circulación. Rebasar por él es ilegal y extremadamente peligroso.',
  ),
  Question(
    id: 53,
    text:
    ...
    category: QuestionCategory.circulacion,
    explanation:
        'Por seguridad, el vehículo debe estar completamente detenido para que los pasajeros suban o bajen. Hacerlo en movimiento causa accidentes graves.',
  ),
  ...
  Question(
    ...
    explanation:
        'La UMA (Unidad de Medida y Actualización) se usa como referencia para multas. Conducir sin licencia es una falta grave sancionada con 20 UMAs.',
  ),
  Question(
    id: 8,
    text:
    ...
    category: QuestionCategory.multas,
    explanation:
        'Los vehículos foráneos con adeudos de infracciones pueden ser sancionados con el retiro de placas como garantía del pago pendiente.',
  ),
  Question(
    id: 10,
    text:
    ...
    category: QuestionCategory.multas,
    explanation:
        'El conductor es legalmente responsable de lo que sucede dentro y desde su vehículo. Debe asegurar que ningún pasajero arroje basura a la vía pública.',
  ),
  Question(
    id: 13,
    text:
    ...
    category: QuestionCategory.multas,
    explanation:
        'La contaminación auditiva por ruido excesivo de claxon o escape se sanciona con 5 UMAs. Esto incluye escapes modificados y uso innecesario del claxon.',
  ),
  Question(
    id: 23,
    text:
    ...
    category: QuestionCategory.multas,
    explanation:
        'No respetar los programas ambientales (como "Hoy No Circula") es una infracción grave: multa de 20 UMAs más la retención del vehículo.',
  ),
  Question(
    id: 24,
    text:
    ...
    category: QuestionCategory.multas,
    explanation:
        'Conducir abrazado a una persona u objeto impide el manejo seguro del vehículo, poniendo en riesgo la seguridad vial. Se sanciona con 20 UMAs.',
  ),
  Question(
    id: 26,
    text:
    ...
    category: QuestionCategory.multas,
    explanation:
        'La discrepancia entre placas y documentos puede indicar un vehículo robado o documentación irregular. Se sanciona con 20 UMAs y retención.',
  ),
  Question(
    id: 28,
    text:
    ...
    category: QuestionCategory.multas,
    explanation:
        'Conducir en estado de ebriedad es una falta gravísima. El conductor será detenido y presentado ante la autoridad competente para ser procesado.',
  ),
  Question(
    id: 32,
    text:
    ...
    category: QuestionCategory.multas,
    explanation:
        'Instalar dispositivos de emergencia (torretas, faros rojos) en vehículos particulares es ilegal porque puede usarse para suplantar a la autoridad. Multa de 20 UMAs.',
  ),
  Question(
    id: 35,
    text:
    ...
    category: QuestionCategory.multas,
    explanation:
        'Las llantas lisas reducen drásticamente el agarre, aumentando la distancia de frenado y el riesgo de accidentes. Se multa con 5 UMAs.',
  ),
  ...
  Question(
    ...
    explanation:
        'La tarjeta de circulación especifica la capacidad máxima de pasajeros según el tipo de vehículo. Exceder este número es una infracción.',
  ),
  Question(
    id: 4,
    text:
    ...
    category: QuestionCategory.seguridad,
    explanation:
        'El cinturón de seguridad es obligatorio para todos los ocupantes del vehículo, tanto en asientos delanteros como traseros. Reduce un 50% el riesgo de muerte en accidentes.',
  ),
  Question(
    id: 7,
    text:
    ...
    category: QuestionCategory.seguridad,
    explanation:
        'Está prohibido estacionarse en camellones, rampas para discapacitados, en doble fila y en áreas peatonales. Esto garantiza la accesibilidad y seguridad.',
  ),
  Question(
    id: 15,
    ...
    category: QuestionCategory.seguridad,
    explanation:
        'Tanto el conductor como el acompañante de una motocicleta deben usar casco y anteojos protectores en todo momento y en cualquier vía.',
  ),
  Question(
    id: 20,
    text:
    ...
    category: QuestionCategory.seguridad,
    explanation:
        'Usar el celular al conducir está prohibido, incluso con manos libres. La distracción al volante es una de las principales causas de accidentes.',
  ),
  Question(
    id: 31,
    text:
    ...
    category: QuestionCategory.seguridad,
    explanation:
        'Para operadores de transporte público, carga y sustancias peligrosas, la tolerancia de alcohol es CERO. Dada su responsabilidad, no se permite ningún nivel de alcohol.',
  ),
  Question(
    id: 36,
    text:
    ...
    category: QuestionCategory.seguridad,
    explanation:
        'Los peatones también deben respetar el reglamento de tránsito. Si no lo hacen, la sanción es una amonestación (advertencia verbal).',
  ),
  Question(
    id: 52,
    ...
    category: QuestionCategory.seguridad,
    explanation:
        'Estacionarse en doble fila nunca está permitido. Obstaculiza la circulación, genera tráfico y puede causar accidentes.',
  ),
  ...
  Question(
    ...
    explanation:
        'Solo se permiten vidrios polarizados de fábrica. Los polarizados instalados posteriormente están prohibidos porque dificultan la identificación del conductor.',
  ),
  Question(
    id: 16,
    text:
    ...
    category: QuestionCategory.vehiculo,
    explanation:
        'Los menores con permiso provisional deben ir SIEMPRE acompañados por un adulto con licencia vigente, sin excepción, para garantizar supervisión constante.',
  ),
  Question(
    id: 17,
    text:
    ...
    category: QuestionCategory.vehiculo,
    explanation:
        'Es obligatorio contar con seguro de responsabilidad civil que cubra al menos daños a terceros. Esto protege económicamente a las víctimas de un accidente.',
  ),
  Question(
    id: 18,
    ...
    category: QuestionCategory.vehiculo,
    explanation:
        'Conducir bajo efectos de alcohol o drogas es causa de cancelación definitiva de la licencia. Es la falta más grave contemplada en el reglamento.',
  ),
  Question(
    id: 22,
    text:
    ...
    category: QuestionCategory.vehiculo,
    explanation:
        'La carga puede sobresalir máximo 1 metro de las dimensiones laterales del vehículo. Debe señalizarse adecuadamente para ser visible a otros conductores.',
  ),
  Question(
    id: 33,
    ...
    category: QuestionCategory.vehiculo,
    explanation:
        'Las luces delanteras deben ser de color blanco para iluminar correctamente la vía sin deslumbrar en exceso a otros conductores.',
  ),
  Question(
    id: 34,
    text:
    ...
    category: QuestionCategory.vehiculo,
    explanation:
        'Los faros traseros blancos están prohibidos porque podrían confundirse con las luces delanteras, desorientando a otros conductores sobre la dirección del vehículo.',
  ),
  Question(
    id: 45,
    text:
    ...
    category: QuestionCategory.vehiculo,
    explanation:
        'Los detectores de radares están totalmente prohibidos. Su uso busca evadir los controles de velocidad, lo que pone en riesgo la seguridad vial.',
  ),
  Question(
    id: 46,
    text:
    ...
    category: QuestionCategory.vehiculo,
    explanation:
        'Presentar documentación falsa o proporcionar información falsa es motivo para negar la licencia. La falsificación de documentos es además un delito.',
  ),

  // ═══════════════════════════════════════════════════════════════════════════
  // PRIORIDADES Y ACCIDENTES
  // ═══════════════════════════════════════════════════════════════════════════
  Question(
    id: 12,
    ...
    explanation:
        'En las glorietas, la preferencia es de los vehículos que ya están dentro circulando. Los que desean entrar deben esperar un espacio seguro.',
  ),
  Question(
    id: 25,
    ...
    category: QuestionCategory.prioridades,
    explanation:
        'Solo los vehículos de emergencia (ambulancias, patrullas, bomberos) pueden usar carriles de contraflujo cuando están atendiendo una emergencia.',
  ),
  Question(
    id: 27,
    text:
    ...
    category: QuestionCategory.prioridades,
    explanation:
        'Solo se presentan ante la autoridad cuando no hay acuerdo entre las partes. Si ambos acuerdan la reparación de daños, pueden resolverlo sin autoridad.',
  ),
  Question(
    id: 29,
    text:
    ...
    category: QuestionCategory.prioridades,
    explanation:
        'Los agentes de tránsito tienen la obligación de auxiliar a los conductores cuando su vehículo se descompone en la vía, para evitar obstrucciones y accidentes.',
  ),
  Question(
    id: 30,
    text:
    ...
    category: QuestionCategory.prioridades,
    explanation:
        'En accidentes con solo daños materiales, el agente debe promover un arreglo rápido entre las partes para liberar la vialidad lo antes posible.',
  ),
  Question(
    id: 47,
    text:
    ...
    category: QuestionCategory.prioridades,
    explanation:
        'Los vehículos de emergencia solo tienen preferencia de paso cuando circulan con la sirena encendida o la torreta luminosa activada, indicando que atienden una emergencia.',
  ),
  Question(
    id: 48,
    text:
    ...
    category: QuestionCategory.prioridades,
    explanation:
        'Al incorporarse a una vía primaria, siempre se debe ceder el paso a los vehículos que ya circulan por ella. La vía primaria tiene preferencia.',
  ),
  Question(
    id: 50,
    text:
    ...
    category: QuestionCategory.prioridades,
    explanation:
        'Es obligatorio permanecer en el lugar, brindar auxilio y avisar a las autoridades. Abandonar la escena de un accidente con lesionados es un delito grave.',
  ),
];
